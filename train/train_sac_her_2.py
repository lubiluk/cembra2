...
ac_kwargs = dict(hidden_sizes=[64, 64, 64, 64, 64], activation=th.nn.ReLU)

logger_kwargs = dict(
    output_dir='data/pepper_push_sac_her_2',
    exp_name='pepper_push_sac_her_2')
