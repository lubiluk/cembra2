...
class ReplayBuffer:
    """
    A simple FIFO experience replay buffer for SAC HER agents.
    """
    ...
    def synthesize_experience(env,
        ...
        for idx in range(ep_end):
            ...
            for _ in range(num):
                ...
                sel_obs2 = {
                    "observation": ep["obs2"]["observation"][sel_idx],
                    "desired_goal": ep["obs"]["desired_goal"][sel_idx],
                    "achieved_goal": ep["obs"]["achieved_goal"][sel_idx]
                }
