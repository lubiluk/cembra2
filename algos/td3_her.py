...
def td3_her(env_fn, actor_critic=core.MLPActorCritic, ac_kwargs=dict(), seed=0, 
...
if __name__ == '__main__':
    ...
    td3_her(lambda : gym.make(args.env), actor_critic=core.MLPActorCritic,
